...
namespace TestAutomation.WebDriver.WebComponents
{
    ...
    public class Element :  IElement
    {
        ...
        /// <summary>
        /// Constructor with parameters as findby and value
        /// </summary>
        /// <param name="type"></param>
        /// <param name="value"></param>
        /// <author> Suresh Racha</author>

        public Element(FindBy type, string value)
        {
        ...
        /// <param name="value"></param>
        /// <author> Suresh Racha</author>
        public Element(MultiBrowser browser, FindBy type, string value)
        {
        ...
        /// <summary>
        /// Constructor takes IObjectLocator as parameter
        /// </summary>
        /// <param name="Locator"></param>
        /// <author> Suresh Racha</author>
        public Element(IObjectLocator Locator)
        {
