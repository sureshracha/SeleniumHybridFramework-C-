...
namespace TestAutomation.WebDriver.WebComponents
{
    ...
    public class WebButton :    IWebButton
    {
        ...
        /// <summary>
        /// Constructor takes object loctor as param
        /// </summary>
        /// <param name="Locator"></param>
        
        public WebButton(IObjectLocator Locator)
        {
        ...
        public WebButton(MultiBrowser browser,FindBy type, string value)
        {
        ...
        public WebButton(FindBy type, string value)
        {
