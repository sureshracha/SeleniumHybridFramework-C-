...
namespace TestAutomation.WebDriver.WebComponents
{
    public class WebTable : IWebTable
    {
        ...
        public WebTable(MultiBrowser browser, FindBy type, string value)
        {
        ...
        public WebTable(FindBy type, string value)
        {
        ...
        public WebTable(IObjectLocator Locator)
        {
