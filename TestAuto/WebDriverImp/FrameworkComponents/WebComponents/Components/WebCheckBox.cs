...
namespace TestAutomation.WebDriver.WebComponents
{
    public class WebCheckBox : IWebCheckBox
    {
        ...
        public WebCheckBox(FindBy type, string value)
        {
        ...
        /// <param name="value"></param>
        /// <author> Suresh Racha</author>
        public WebCheckBox(MultiBrowser browser, FindBy type, string value)
        {
        ...
        public WebCheckBox(IObjectLocator Locator)
        {            
        ...
        public void Select()
        {
            if (IsEnabled())
            {
                ...
                this.wr.SelectSingleCheckboxe(this.locator);
            }
        }
        /// <summary>
        ...
        public void UnSelect()
        {
            if (IsEnabled())
            {
                ...
                this.wr.UnselectSingleCheckboxe(this.locator);
            }
        }
        /// <summary>
