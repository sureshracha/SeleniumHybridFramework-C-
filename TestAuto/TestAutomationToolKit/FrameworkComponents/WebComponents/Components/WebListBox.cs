...
namespace TestAutomation.WebDriver 
{
    public class WebListBox : IWebListBox
    {
        ...
        public WebListBox(Browser browser, FindBy type, string value)
        {
        ...
        public void SelectItemByValue(String val)
        {
            ...
            {
                SelectElement element = new SelectElement(this.ele);
                element.SelectByValue(val);
            }
        }
        /// <summary>
        ...
        public void DeSelectItemByIndex(int ilndex)
        {
            ...
            {
                SelectElement element = new SelectElement(this.ele);
                element.DeselectByIndex(ilndex);
            }
